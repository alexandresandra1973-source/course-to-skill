...
def run():
    ...
    a1 = F.fusion_id(SPH, CFG_1, CAR, ADM, OUT, ERR)
    a2 = F.fusion_id(list(reversed(SPH)), CFG_1, CAR, ADM, OUT, ERR)
    ...
    b = F.fusion_id(SPH, CFG_2, CAR, ADM, OUT, ERR)
    ...
    c1 = F.fusion_id(SPH, CFG_1, CAR, ADM, OUT, ERR)   # sob "politica MTX X"
    c2 = F.fusion_id(SPH, CFG_1, CAR, ADM, OUT, ERR)   # sob "politica MTX Y"
    ...
    cfg = json.load(open("FUSION-CONFIG-IDENTITY-REVERIFY.json", encoding="utf-8"))
