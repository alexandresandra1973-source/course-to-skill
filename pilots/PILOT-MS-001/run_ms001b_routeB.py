#!/usr/bin/env python3
"""PILOT-MS-001B — ROUTE B. Transporte: processo `claude -p` novo por chamada,
...
HARD_CAP= 18
DRY     = "--dry" in sys.argv
OUT     = H / ("out-ms001b-exec3-dry" if DRY else "out-ms001b-exec3")
...
def main():
    ...
    R = {"pilot": "PILOT-MS-001B", "execution": "EXEC-3",
