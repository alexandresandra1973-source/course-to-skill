#!/usr/bin/env python3
"""PILOT-004 · PASS 1 — temporal-map por janelas de 20 min.
Copia do p003_pass1.py (sha256 60f0bedc…). Diff MINIMO: caminhos, nome do
manifesto e pilot_id. Nenhuma logica, prompt, schema, WIN ou TARGET alterado."""
from __future__ import annotations
import hashlib, json, os, re, time
from pathlib import Path
import anthropic, yaml

DRIVE = Path("/Users/alexandresandra/p004-work")
SRC = DRIVE / "00_SOURCE"
OUT = DRIVE / "01_PASS1"
...
def main() -> int:
    ...
    meta = yaml.safe_load((SRC/"SOURCE-MANIFEST-PILOT-004.yaml").read_text(encoding="utf-8"))
    ...
    tm={"schema_version":"0.1.0","pilot_id":"PILOT-004",
    ...
    Path("/Users/alexandresandra/p004-work/01_PASS1/p004-pass1-calls.json").write_text(
