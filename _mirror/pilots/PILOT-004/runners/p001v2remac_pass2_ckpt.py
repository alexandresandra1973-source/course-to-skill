#!/usr/bin/env python3
"""PILOT-004 · PASS 2 com CHECKPOINT POR SEGMENTO e retomada. Tudo em disco local.
Copia do p003_pass2_ckpt.py (sha256 7364ff32…). Diff MINIMO: caminhos, pinos de
insumo, pilot_id, compiler_version e nome do runner. Nenhuma logica alterada.
...
CL = Path("/Users/alexandresandra/p004-work")
sys.path.insert(0, str(CL / "compiler-v2-snapshot"))
W = Path("/Users/alexandresandra/p004-work/p001v2-remac")
CKPT = W / "02_PASS2/pass2-checkpoint.jsonl"
EXPECT = {"L0": "068b4998c160d143ee6bc2942e444157fdaebb4311b2ca9eced625c22626df67",
          "tmap": "845cea7df28d1d697cea904f747d0642f937295ab1a67bd5c83e84e88327bf60"}
...
def main() -> int:
    ...
    meta = yaml.safe_load((W/"00_SOURCE/SOURCE-MANIFEST-PILOT-004.yaml").read_text(encoding="utf-8"))
    ...
    man = {"pilot_id": "PILOT-001-v2-REMAC", "compiler_version": "compiler-v2/0.2.1-frozen",
           "runner": "p004_pass2_ckpt.py — copia de p003_pass2_ckpt.py (sha256 7364ff32…) com diff minimo declarado; checkpoint por segmento, APFS",
